 ...
 * @param {typeof Buffer} buffer Buffer class to use (browser shim)
 */
function Type(type, buffer = Buffer) {
	/**
	 ...
	 */
	/**
	 * @member {typeof Buffer} Type#buffer
	 */
...
Type.prototype.encode = function (value) {
	var data = new Data(128, this.buffer);
...
Type.prototype.getHash = function () {
	var hash = new Data(128, this.buffer)
